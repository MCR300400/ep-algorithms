...
<template>
  <div class="pagina-home">
    ...
    <!-- Algoritmi principali in evidenza -->
    <section class="sezione-in-evidenza">
      ...
      <div class="griglia-anteprime">
        <RouterLink
          v-for="algo in algoritmiInEvidenza"
          :key="algo.id"
